...
- Developed tool to generate gas production forecasts and drilling schedule (this work was published).  A simulator, called Field Planner was developed using the concept of type curves, i.e., rate vs cumulatives.  This simulator can simulate 20 years production forecasts in less than 10 seconds, and the results were comparable with a commercial simulator (ECLIPSE).
...
## Publications
1.	Bohgaindran Raj Sitravellu, Sami Abdelrahman Musa Yagoub, **Akmal Aulia**, "Comparative Study of Variance-Based and One-Parameter-at-A-time Sensitivity Analysis Method for Polymer Flood Performance History Matching", 2021 International Field Exploration and Development Conference in Qingdao, China, 20-22 October, 2021.
